  ...
  <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('./public/assets/imgs/image1.jpg')">
        ...
        <div class="carousel-item" style="background-image: url('./public/assets/imgs/image2.jpg')">
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item" style="background-image: url('./public/assets/imgs/image3.jpg')">
          <div class="carousel-caption d-none d-md-block">
     ...
     <main role="main">
      <div class="jumbotron">
        <div class="container">
          <h1 class="display-3">{{$lang("Hello, world!")}}</h1>

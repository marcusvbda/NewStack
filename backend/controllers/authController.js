const authController = function () {
    ...
    this.sendConfirmationEmail = async (user) => {
        ...
        `
        await this.Mailer.send({ subject: "Confirm your account", to: user.email, html: html })
    }
    ...
    this.recovery = async (req, res) => {
        ...
        return res.json({ success: true, message: { content: 'An email has been sent, check your inbox', type: 'success' }, data: null })
    }

    this.sendRecoveryEmail = async (user) => {
        ...
        let html = `
            ...
            <p style="margin-top:30px">Thank you, ${process.env.APP_NAME}
        `
        this.Mailer.send({ subject: "Renew your password", to: user.email, html: html })
    }
